...
function submitUpdateOrderStatus(event){
	var checkboxes = document.getElementsByName('toggle_status');
	...
	document.getElementById('toggle_array').value = checkboxesChecked;
	document.getElementById('admin_order_status').submit();
}